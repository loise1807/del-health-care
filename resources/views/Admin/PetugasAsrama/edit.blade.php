  ...
  <form method="post" action="/admin/petugas_asramas/{{$petugas_asrama->no_pegawai}}" enctype="multipart/form-data">
    ...
    <div class="row g-2">
      <div class="mb-3 col-lg-6">
        ...
        <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('no_pegawai') is-invalid @enderror" id="no_pegawai" name="no_pegawai" required value="{{ $petugas_asrama->no_pegawai }}">
        @error('no_pegawai')
      ...
      <div class="mb-3 col-md-6">
        ...
        <div class="input-group mb-2">
          ...
          <input type="text" onkeypress="return hanyaAngka(event)" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" value="{{ $petugas_asrama->no_telp }}" placeholder="81234567890">
          @error('no_telp')
          <div class="invalid-feedback">
            {{ $message }}
          </div>
