          ...
          <div class="row g-0">
            <div class="col-md-3">
              ...
              <div style="overflow:hidden;" class="mt-3 mb-3">
                <img class="" src="{{ asset('storage/' . $pengurus->image) }}" alt="https://source.unsplash.com/190x350?people" style="height: 350px;width:190px">
              </div>
              @else
              ...
              <div class="card-body row g-2">
                ...
                <div>
                  <div class="col-md-6">
                    ...
                    <a href="/petugas/profile/{{ $pengurus->id }}" class="btn text-white mb-3" style="background-color: #07be94;">Ubah Data</a>
                  </div>
                </div>
